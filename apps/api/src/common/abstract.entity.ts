...
import { type AbstractDto, type AbstractTranslationDto } from './dto/abstract.dto';
...
export class AbstractTranslationEntity<DTO extends AbstractTranslationDto = AbstractTranslationDto, O = never> extends AbstractEntity<
  DTO,
  O
> {
