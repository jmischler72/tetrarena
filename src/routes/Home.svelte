...
<style lang="scss">
  ...
  :global(body) {
    ...
    --card-label-color: #D4D4D8;
    --card-icon-color: #D4D4D8;
    --card-icon-background-color: rgba(255, 255, 255, 0.08);
    --card-icon-border-color: rgba(255, 255, 255, 0.12);
    --card-shine-opacity: .1;
    --card-shine-gradient: conic-gradient(from 205deg at 50% 50%, #3e2d8a 0deg, #332769 25deg, #302852 295deg, #272140 360deg);
    --card-line-color: #2A2B2C;
    --card-tile-color: #272140;
    ...
    --card-hover-icon-color: #d3c9ff;
    --card-hover-icon-background-color: #1d192e;
